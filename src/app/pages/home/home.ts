import { Component, HostListener, AfterViewInit, OnDestroy, ViewChildren, QueryList, ElementRef, Inject, PLATFORM_ID } from '@angular/core';
...
export class Home implements AfterViewInit, OnDestroy {
  ...
  engines = [
    { id: '01', title: 'TF-2841 Turbofan', client: 'Boeing 777-300ER', img: '/images/engine-1.jpg', health: '92%' },
    { id: '02', title: 'CFM56-7B', client: 'Boeing 737-800', img: '/images/engine-2.jpg', health: '87%' },
    { id: '03', title: 'GP7200', client: 'Airbus A380-800', img: '/images/engine-3.jpg', health: '71%' },
    { id: '04', title: 'LEAP-1A', client: 'Airbus A320neo', img: '/images/engine-4.jpg', health: '96%' },
    { id: '05', title: 'PW1100G-JM', client: 'Airbus A320neo', img: '/images/engine-5.jpg', health: '94%' },
    { id: '06', title: 'Trent 900', client: 'Airbus A380-800', img: '/images/engine-6.jpg', health: '89%' },
  ];
  ...
  private drawImage(canvas: HTMLCanvasElement, img: HTMLImageElement, strength: number, rands: number[]) {
